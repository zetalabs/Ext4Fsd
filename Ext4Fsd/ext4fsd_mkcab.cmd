...
cabarc -p -r n cab\ext4fsd.cab Release\ext4fsd_dummy.inf Release\ext4fsd*.sys Release\ext4fsd*.pdb || goto :eof

if not exist cab\ext4fsd.cab goto :eof

signtool sign /a /as /v /sha1 a065b19d9f5a23bc67bb1cf6872283f504ba04b1 /fd sha256 /tr "http://sha256timestamp.ws.symantec.com/sha256/timestamp" cab\ext4fsd.cab || goto :eof
