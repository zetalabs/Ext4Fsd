; ext4fsd.nsi
;
; This is a NSIS script to create an install program for the Ext4Fsd project
; originally developed by Bo Brantén <bosse@accum.se> in 2020 to help beta testing.
; modified by Hui Tang <david921518@qq.com> in 2025.
;
; To build an installation program follow these steps:
; 1. Install NSIS (Nullsoft Scriptable Install System)
; 2. Compile Ext2Mgr, Ext2Srv and Ext4Fsd.
; 3. Run the command "makensis ext4fsd.nsi"
; This will create an install program called "Ext4Fsd-setup.exe".
...
!define PROJECTNAME "Ext4Fsd"
!define DRIVERNAME "Ext4Fsd"
Icon "..\Ext2Mgr\res\Ext2Mgr.ico"
Caption "${PROJECTNAME} 0.71"
DirText "This is a release of the ${PROJECTNAME} project from Hui Tang to test the new ext4 features metadata checksums and 64-bit block numbers. You may choose the install directory:"
...
!define MSVPATH_X86 "D:\VS\2022\Community\VC\Redist\MSVC\14.42.34433\x86\Microsoft.VC143.CRT"
!define MSVPATH_X64 "D:\VS\2022\Community\VC\Redist\MSVC\14.42.34433\x64\Microsoft.VC143.CRT"
!define MFCPATH_X86 "D:\VS\2022\Community\VC\Redist\MSVC\14.42.34433\x86\Microsoft.VC143.MFC"
!define MFCPATH_X64 "D:\VS\2022\Community\VC\Redist\MSVC\14.42.34433\x64\Microsoft.VC143.MFC"
