...
; modified by Tang Hui <david921518@qq.com> in 2025.
;
...
DirText "This is a release of the ${PROJECTNAME} project from TANG HUI(david921518@qq.com) to test the new ext4 features metadata checksums and 64-bit block numbers. You may choose the install directory:"
